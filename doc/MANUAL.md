...
you're on an x86_64 or aarch64 Linux system, simply run `cargo build` in the top-level directory to
build with default features and using pre-built shims for interaction with accelerator cards
(currently NVIDIA, AMD, Intel XPU and Intel Habana).

### Building RPMs

TODO - RPM or similar, things will appear in ../build-dist.  I think I want the generic
