# RPM build spec for Sonar on a typical HPC compute node with NVIDIA accelerators.
#
# The build script below activates gcc, Rust, Binutils, and CUDA headers as necessary.  YOU MAY NEED
# TO ALTER THESE SETTINGS FOR YOUR SYSTEM.
#
...
#
# Here load dependencies via lmod.  The versions that are available will differ from system to
# system.
...
SONAR_CUSTOM_GPUAPI=$SHIMDIR cargo build --no-default-features --features=daemon,kafka,nvidia --release
